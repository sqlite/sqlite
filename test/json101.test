...
# Bug 2026-07-04T04:58:54Z
#
# The JSONB is corrupt such that the last member of the structure has
# a label but no value.  The jsonSkipLabel() should return the index
# of the label, making the value appear to be the same as the label
# as far as json_each() is concerned.
#
